<template>
  <div class="flex flex-wrap justify-center gap-6 pt-16">
    ...
    >
      ...
      <!-- Button -->
      <button
        class="mt-5 bg-blue-500 hover:bg-blue-600 text-white font-medium text-sm py-2 px-6 rounded-full shadow transition duration-300"
      >
        View Details
      </button>
    </div>
